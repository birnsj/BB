...
## [code]PropsInteract[/code] (layer 3) | [code]NpcInteract[/code] (layer 7) — clicks here should not commit move-to-point.
...
## [code]true[/code] if [param world_pos] overlaps a body/area on [member MOVE_TO_POINT_BLOCK_MASK] (items, NPC click areas, etc.).
